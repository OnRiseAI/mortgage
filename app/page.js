  ...
  return (
    <div className="min-h-screen relative">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 py-12 md:py-20">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 lg:gap-y-8 lg:gap-x-20 items-start">
          {/* ─── Intro Section ─── */}
          <div className="order-1 lg:col-start-1 lg:row-start-1 animate-float-in w-full">
            {/* Badge */}
            <div>
              ...
              <p className="font-body text-base text-white/40 mt-4 max-w-md leading-relaxed">
                ...
                clients would typically call in with. See how she handles it.
              </p>
            </div>

            {/* What Sophie Can Do */}
            <div className="order-3 lg:col-start-1 lg:row-start-2 glass-card rounded-2xl p-6 space-y-5 animate-float-in w-full mt-2 lg:mt-0">
              <h3 className="font-display text-sm font-semibold text-amber-400">
                What Sophie handles for you
              </h3>
              <div className="space-y-4">
                {[
                  ...
                  <div key={item} className="flex items-start gap-3">
                    ...
                    <span className="font-body text-[15px] text-white/70 leading-relaxed">{item}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Try Asking */}
            <div className="order-4 lg:col-start-1 lg:row-start-3 space-y-4 animate-float-in w-full mt-2 lg:mt-0 pb-8 lg:pb-0">
              ...
              <div className="flex flex-wrap gap-2.5">
                {suggestions.map((s) => (
                  <span
                    key={s}
                    className="px-4 py-2 rounded-full text-[13px] font-body text-white/60 border border-white/[0.08] bg-white/[0.03] hover:border-amber-400/30 hover:text-amber-400/70 transition-all cursor-default"
                  >
                    &ldquo;{s}&rdquo;
                  </span>
                ))}
          ...
          <div
            className="order-2 lg:col-start-2 lg:row-start-1 lg:row-span-3 w-full lg:sticky lg:top-[120px]"
            style={{
                  ...
                  <div className="text-center space-y-6">
                    <div className="relative w-20 h-20 mx-auto">
                      ...
                      <div className="relative w-20 h-20 rounded-full border border-amber-400/20 overflow-hidden flex items-center justify-center bg-gradient-to-br from-amber-400/20 to-amber-600/20">
                        <Image
                          src="/headshot-example-4-removebg-preview.png"
                          alt="Sophie"
                          width={80}
                          height={80}
                ...
                {callState === "connecting" && (
                  <div className="text-center space-y-6">
                    ...
                    <div>
                      ...
                      <p className="font-body text-sm text-white/40 mt-1">
                        Setting up your call with Sophie
                      </p>
                    </div>
                  </div>
                )}
                ...
                {callState === "ended" && (
                  <div className="text-center space-y-6">
                    ...
                    <div>
                      ...
                      <p className="font-body text-sm text-white/40 mt-1">
                        What did you think? Give Sophie another go or call us to chat.
                      </p>
